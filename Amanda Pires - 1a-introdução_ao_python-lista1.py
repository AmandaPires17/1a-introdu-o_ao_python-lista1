...
def metro_para_milimetros(metros):
    ...
    Retorna: float: o valor convertido para milimetros, 
    """
...
def preco_com_desconto(preco_original, percentual_desconto):
    ...
    """
    preco_original -= preco_original * (percentual_desconto / 100)
    return round (preco_original, 2)
...
def celsius_para_fahrenheit(celsius):
    ...
    """
    graus_ferenheit = (celsius * 9/5) + 32 

    return graus_ferenheit 
...
def dias_perdidos_por_fumar(cigarros_fumados_por_dia, anos_fumando):
    ...
    """
    return round ((cigarros_fumados_por_dia * anos_fumando * 365 * 10 / 60 / 24),2)
...
def media_final_aprovado_reprovado(p1, p2, ep1, ep2):
    ...
    media_final = (parcial1 + parcial2) / 2
